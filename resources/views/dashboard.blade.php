<x-layouts::app :title="__('Dashboard')">
    <div class="space-y-8">
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            {{-- Recent activity --}}
            <div class="lg:col-span-2 bg-base-100 rounded-xl border border-zinc-200 dark:border-zinc-700">
            ...
            <div class="space-y-6">
                {{-- Quick actions --}}
                <div class="bg-base-100 rounded-xl border border-zinc-200 dark:border-zinc-700">
